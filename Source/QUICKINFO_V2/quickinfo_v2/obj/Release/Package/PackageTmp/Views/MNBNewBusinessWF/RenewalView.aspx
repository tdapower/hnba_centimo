<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="RenewalView" Title="Renewal" CodeBehind="RenewalView.aspx.cs" %>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label for="chkIsSameBranch" class="col-sm-4 control-label">Is Own Branch</label>
                                            <div class="col-sm-5">
                                                <asp:Panel ID="Panel1" runat="server">
                                                    <%--<div id="label-switch" class="make-switch" data-on-label="Yes" data-off-label="No" style="width: 255px;">--%>

                                                    <asp:CheckBox ID="chkIsSameBranch" runat="server" Checked="true" AutoPostBack="True" OnCheckedChanged="chkIsSameBranch_CheckedChanged" CssClass="form-control" />
                                        ...
                                        <asp:UpdatePanel ID="pnlBranch" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:Panel ID="pnlBranchList" runat="server">
                                                    <div class="form-group">
                                                        <label for="ddlBranch" class="col-sm-4 control-label">Branch</label>
                                                        <div class="col-sm-5">
