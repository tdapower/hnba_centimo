<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RejectedJobList.aspx.cs" Inherits="quickinfo_v2.Views.Common.RejectedJobList" %>
            ...
            <div class="row">
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        Rejected Job Summary
                    </div>
                </div>
                <div class="col-sm-12">
                    <asp:GridView ID="grdRejectedJobSummary" runat="server" CssClass="myGridStyle-small ">
