<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchTCSQuoteNo.aspx.cs" Inherits="quickinfo_v2.Views.MNBNewBusinessWF.SearchTCSQuoteNo" %>
    ...
    <script type="text/javascript">
        function GetSelectedRow(lnk) {
           ...
           // alert(QuoteNo);
            ...
            var txtQuoteNo = parent.document.getElementById("ContentPlaceHolder1_txtTCSQuoteNo");
        ...
        <form role="form" class="form-horizontal form-groups-bordered" runat="server">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="txtSearchProposalNo" class="col-sm-3 control-label">Quote No</label>
