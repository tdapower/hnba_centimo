<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ProcessValidatorView.aspx.cs" Inherits="quickinfo_v2.Views.MNBNewBusinessWF.ProcessValidatorView" %>
                    ...
                    <div class="panel panel-primary" data-collapsed="0" style="height: 600px">
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="panel-options">
                                ...
                                --%>
                                <asp:DropDownList ID="ddlPrefJobType" CssClass="selectboxit" runat="server" OnSelectedIndexChanged="ddlPrefJobType_SelectedIndexChanged" AutoPostBack="true">
                                </asp:DropDownList><br />
                            ...
                            <div class="form-group">
                                <div class="col-sm-5">
                                    ...
                                    <asp:UpdatePanel ID="up_Timer" runat="server" RenderMode="Inline" UpdateMode="Always">
                                        <Triggers>
                                            <asp:AsyncPostBackTrigger ControlID="tmrJobTime" EventName="Tick" />
                                        </Triggers>
                                        <ContentTemplate>
                                            <asp:Timer ID="tmrJobTime" runat="server" Interval="1000" OnTick="tmrJobTime_Tick" />
                                ...
                                <div class="panel-body">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <asp:TextBox ID="txtTCSPolicyID" CssClass="form-control" runat="server" Visible="false"></asp:TextBox>
                                            ...
                                            <asp:TextBox ID="txtSystemName" CssClass="form-control" runat="server" Visible="false"></asp:TextBox>

                                            <div class="form-group">
                                                <label for="txtJobTypeName" class="col-sm-4 control-label">Job Type</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                <label for="txtProposalNo" class="col-sm-4 control-label">Proposal No</label>
                                                <div class="col-sm-8">
                                                    <asp:TextBox ID="txtProposalNo" CssClass="form-control" runat="server"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="txtIssueType" class="col-sm-4 control-label">Issue Type</label>
                                                <div class="col-sm-8">
                                                    <asp:TextBox ID="txtIssueType" CssClass="form-control" runat="server" onfocus="blur()"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="txtPolicyType" class="col-sm-4 control-label">Policy Type</label>
                                                <div class="col-sm-8">
                                                    <asp:TextBox ID="txtPolicyType" CssClass="form-control" runat="server" onfocus="blur()"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="txtJobRemarks" class="col-sm-4 control-label">Job Remarks</label>
                                                <div class="col-sm-8">
                                                    <asp:TextBox ID="txtJobRemarks" CssClass="form-control" runat="server" onfocus="blur()"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="txtScrutinizationRemarks" class="col-sm-4 control-label">Scrutinization Remarks</label>
                                                <div class="col-sm-8">
                                                    <asp:TextBox ID="txtScrutinizationRemarks" CssClass="form-control" runat="server" onfocus="blur()"></asp:TextBox>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="txtProcessingRemarks" class="col-sm-4 control-label">Processing Remarks</label>
                                                <div class="col-sm-8">
                                                    <asp:TextBox ID="txtProcessingRemarks" CssClass="form-control" runat="server" onfocus="blur()"></asp:TextBox>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group" style="display: none">
                                                <label for="rdbtnCoverNoteAvailable" class="col-sm-4 control-label">Is Cover Note Available</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group" style="display: none">
                                                <label for="txtCoverNotePeriod" class="col-sm-4 control-label">Cover Note Period</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group" style="display: none">
                                                <label for="txtAddressLine3" class="col-sm-4 control-label">Address Line3</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group" style="display: none">
                                                <label for="txtYearOfMake" class="col-sm-4 control-label">Year Of Make</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group" style="display: none">
                                                <label for="txtFirstRegDate" class="col-sm-4 control-label">FirstRegDate</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group" style="display: none">
                                                <label for="txtCubicCapacity" class="col-sm-4 control-label">Cubic Capacity</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                <label for="txtCancellationType" class="col-sm-4 control-label">Cancellation Type</label>
                                                <div class="col-sm-8">
                                                    <asp:TextBox ID="txtCancellationType" CssClass="form-control" runat="server" onfocus="blur()"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="txtEndorsementType" class="col-sm-4 control-label">Endorsement Type</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                <label for="chklPendings" class="col-sm-4 control-label">Pendings</label>
                                                <div class="col-sm-8">
                                                    <asp:CheckBoxList ID="chklPendings" runat="server" Enabled="false">
                                                    </asp:CheckBoxList>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="grdUploadedDocs" class="col-sm-4 control-label">Uploaded Documents</label>
                                                <div class="col-sm-8">
                        ...
                        <div class="panel panel-primary" data-collapsed="0">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <asp:TextBox ID="txtRemarks" CssClass="form-control" runat="server" TextMode="MultiLine" Rows="3"></asp:TextBox>
                                    </div>
                                </div>
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <div class="form-group">
                                            <label for="txtTCSPolicyNo" class="col-sm-3 control-label">TCS Policy No</label>
                                            <div class="col-sm-5">
                                                <asp:TextBox ID="txtTCSPolicyNo" CssClass="form-control" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </ContentTemplate>
                                    <Triggers>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-6">
                                        ...
                                        <asp:Button ID="btnOpenCRCPage" runat="server" Text="Open CRC Page"
                                            OnClick="btnOpenCRCPage_Click" CssClass="btn btn-apps" />
                                        ...
                                        <asp:Button ID="btnApprove" runat="server" Text="Complete"
                                            OnClick="btnApprove_Click" CssClass="btn btn-apps" />
