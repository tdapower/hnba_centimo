        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                ...
                <div class="tile-stats tile-plum">
                    ...
                    <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender2" runat="server" PopupControlID="pnlInitial" TargetControlID="UpdatePanel10"
                        CancelControlID="btnClose" BackgroundCssClass="Background">
                    </ajaxToolkit:ModalPopupExtender>
                    <asp:Panel ID="pnlInitial" runat="server" CssClass="Popup" align="center" Style="display: none">
                        <iframe style="width: 800px; height: 600px;" id="Iframe2" runat="server" src="../Common/NotScannedYetJobs.aspx"></iframe>
                        <br />
