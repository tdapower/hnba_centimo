<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ProcessView.aspx.cs" Inherits="quickinfo_v2.Views.MNBNewBusinessWF.ProcessView" %>
                            ...
                            <asp:Panel ID="pnlMissedJobs" runat="server" Height="100%" ScrollBars="Auto" Style="z-index: 102;"
                                ...
                                <asp:UpdatePanel ID="updPnlMissedProposals" runat="server" UpdateMode="Conditional">
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <asp:Timer ID="Timer2" runat="server" Interval="10000" OnTick="tmrUpdateTimer_Tick" />
                                    </ContentTemplate>
                                    <Triggers>
                ...
                <div class="col-md-9">
                    ...
                    <div class="panel panel-primary" data-collapsed="0">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="txtTCSProposalNo" class="col-sm-3 control-label">TCS Proposal No</label>
                                <div class="col-sm-5">
                                    <asp:TextBox ID="txtTCSProposalNo" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
                            </div>
