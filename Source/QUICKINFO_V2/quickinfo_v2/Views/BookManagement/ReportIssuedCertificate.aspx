<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="ReportIssuedCertificate" Title="Certificate Manager" CodeBehind="ReportIssuedCertificate.aspx.cs" %>
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="txtSearchPrintedDateFrom" class="col-sm-3 control-label">Printed Date</label>
                        ...
                        <div class="col-sm-6">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtSearchPrintedDateFrom" CssClass="form-control datepicker" data-format="dd/mm/yyyy" runat="server"></asp:TextBox>
                                </div>
                                <label for="txtSearchPrintedDateTo" class="col-sm-1 control-label">To</label>
                                <div class="col-sm-3">
                                    <asp:TextBox ID="txtSearchPrintedDateTo" CssClass="form-control datepicker" data-format="dd/mm/yyyy" runat="server"></asp:TextBox>
                                </div>
