<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ScrutinizationView.aspx.cs" Inherits="quickinfo_v2.Views.MNBNewBusinessWF.ScrutinizationView" %>
                                ...
                                <div class="panel-body">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <asp:TextBox ID="txtIsValidated" CssClass="form-control" runat="server" Visible="false"></asp:TextBox>
                ...
                <div class="col-md-9">
                    <div class="panel panel-primary" data-collapsed="0">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="txtVehicleChassisNo" class="col-sm-3 control-label">Vehicle / Chassis No.</label>
                                <div class="col-sm-5">
                                    <div class="col-sm-9">
                                        <asp:TextBox ID="txtVehicleChassisNo" CssClass="form-control" runat="server"></asp:TextBox>

                                    </div>
                                    <div class="col-sm-3">
                                        <asp:Button ID="btnValidateVehicleChassisNo" runat="server" Text="Validate"
                                            OnClick="btnValidateVehicleChassisNo_Click" CssClass="btn btn-apps" />
                            ...
                            <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div class="form-group" id="divIsCertificateConvertion" runat="server">
                                        <label for="chkIsCertificateConvertion" class="col-sm-3 control-label">Is Certificate Convertion</label>
                                        <div class="col-sm-5">
