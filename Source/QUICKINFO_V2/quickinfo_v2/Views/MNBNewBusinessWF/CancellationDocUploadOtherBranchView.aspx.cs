...
{
    public partial class CancellationDocUploadOtherBranchView : System.Web.UI.Page
    {
        ...
        private void LoadUploadedProposal()
        {
            ...
            string CANCELLATION_ADDEDStatusName = System.Configuration.ConfigurationManager.AppSettings["CANCELLATION_ADDED"].ToString();




            ProposalUploadController proposalUploadController = new ProposalUploadController();
            grdUploadedProposal.DataSource = proposalUploadController.GetJobsForCancellation(CANCELLATION_ADDEDStatusName, txtUserBranch.Text);
        ...
        protected void btnTakeJob_Click(object sender, EventArgs e)
        {
            ...
            proposalUpload = proposalUploadController.GetEarliestUploadedProposalOfGivenStatusForCancellationDocUpload(CANCELLATION_ADDED, txtUserBranch.Text);
            ...
            proposalUploadController.UpdateProposalUploadStatus(proposalUpload.ProposalUploadId, UserCode, TAKEN_BY_BRANCH_CANCELLATION_DOC_UPLD, "Cancellation Docs Uploaded");
        ...
        protected void btnDone_Click(object sender, EventArgs e)
        {
            ...
            proposalUploadController.UpdateProposalUploadStatus(Convert.ToInt32(txtProposalUploadId.Text), UserCode, CANCELLATION_DOCS_ADDED, txtRemarks.Text);
        ...
        private bool checkIsDocumentsUploaded(string jobNo)
        {
            ...
            string CANCELLATION_DOC_UPLOAD_PATH = "";



            CANCELLATION_DOC_UPLOAD_PATH = System.Configuration.ConfigurationManager.AppSettings["CANCELLATION_DOC_UPLOAD_PATH"].ToString();


            if (File.Exists(CANCELLATION_DOC_UPLOAD_PATH + jobNo + ".pdf"))
            {
                returnVal = true;
            }
