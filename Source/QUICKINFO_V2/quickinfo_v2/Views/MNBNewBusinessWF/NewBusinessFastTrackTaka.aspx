<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="NewBusinessFastTrackTaka" Title="Fast Track" 
    CodeBehind="NewBusinessFastTrackTaka.aspx.cs" %>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <asp:Panel ID="pnlSearchQuotation" runat="server" CssClass="Popup" align="center" Style="display: none">
                                                    <iframe style="width: 800px; height: 600px;" id="Iframe2" runat="server" src="SearchQuotationTakaful.aspx"></iframe>
                                                    <br />
