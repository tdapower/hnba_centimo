...
public partial class DashBoardView : System.Web.UI.Page
{
    string UserCode = "";
    string UserBranch = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblBranchName.Text = lblBranchName.Text + proposalUploadController.getBranchNameOfBranchCode(UserBranch);
    ...
    {
        //  ImageUrl='<%# "../Common/ImageThumbnail.aspx?userCode="+ Eval("APP_CODE") %>'
        UserPhoto.ImageUrl = "../Common/ImageThumbnail.aspx?userCode=" + UserCode + "";
    ...
    private void loadStatusSummary()
    {
        ...
        DataTable dtSummary = dashboardController.getCurrentSummaryOfBranch(UserBranch);
        ...
        ltrlNotInitialised.Text = " <div class=\"num-small\" data-start=\"0\" data-end=" + countOfNotInitialised.ToString() + " data-postfix=\"\" data-duration=\"1500\" data-delay=\"1800\">" + countOfNotInitialised.ToString() + "</div>";

        ltrlScrutinize.Text = " <div class=\"num-small\" data-start=\"0\" data-end=" + countOfScrutinizing.ToString() + " data-postfix=\"\" data-duration=\"1500\" data-delay=\"1800\">" + countOfScrutinizing.ToString() + "</div>";
        ltrlProcess.Text = " <div class=\"num-small\" data-start=\"0\" data-end=" + countOfProcessing.ToString() + " data-postfix=\"\" data-duration=\"1500\" data-delay=\"1800\">" + countOfProcessing.ToString() + " </div>";
        ltrlProcessValidate.Text = " <div class=\"num-small\" data-start=\"0\" data-end=" + countOfValidators.ToString() + " data-postfix=\"\" data-duration=\"1500\" data-delay=\"1800\">" + countOfValidators.ToString() + "</div>";
        ltrlReject.Text = " <div class=\"num-small\" data-start=\"0\" data-end=" + countOfRejected.ToString() + " data-postfix=\"\" data-duration=\"1500\" data-delay=\"1800\">" + countOfRejected.ToString() + "</div>";
        ltrlComplete.Text = " <div class=\"num-small\" data-start=\"0\" data-end=" + countOfCompleted.ToString() + " data-postfix=\"\" data-duration=\"1500\" data-delay=\"1800\">" + countOfCompleted.ToString() + " </div>";
        ltrlUnknown.Text = " <div class=\"num-small\" data-start=\"0\" data-end=" + countOfUnknown.ToString() + " data-postfix=\"\" data-duration=\"1500\" data-delay=\"1800\">" + countOfUnknown.ToString() + "</div>";
        ...
        chartJobTypeCountSummery.Series[0].Font = new Font("Verdana", 10f, FontStyle.Regular);
        ...
        chartJobTypeCountSummery.Legends.Add("Legend2");
        ...
        chartJobTypeCountSummery.Legends[0].Font = new Font("Verdana", 10f, FontStyle.Regular);
    ...
    protected void grdJobSummary_RowDataBound(object sender, GridViewRowEventArgs e)
    {


    }
    protected void grdJobSummary_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        grdJobSummary.PageIndex = e.NewPageIndex;

        loadJobSummary(UserBranch);
    }
    protected void grdCompletedJobSummary_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        grdCompletedJobSummary.PageIndex = e.NewPageIndex;

        loadCompletedJobSummary(UserBranch);
    }


    protected void grdCompletedJobSummary_RowDataBound(object sender, GridViewRowEventArgs e)
    {
