                        ...
                        <div class="panel-body">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <div class="form-group">
                                        <label for="txtProposalNo" class="col-sm-3 control-label">Proposal No</label>
                                        <div class="col-sm-5">
                                            <asp:TextBox ID="txtProposalNo" CssClass="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="txtIssueType" class="col-sm-3 control-label">Issue Type</label>
                                        <div class="col-sm-5">
                                            <asp:TextBox ID="txtIssueType" CssClass="form-control" runat="server" onfocus="blur()"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="txtPolicyType" class="col-sm-3 control-label">Policy Type</label>
                                        <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <label for="txtScrutinizationRemarks" class="col-sm-3 control-label">Scrutinization Remarks</label>
                                        <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <label for="txtProcessingRemarks" class="col-sm-3 control-label">Processing Remarks</label>
                                        <div class="col-sm-5">
