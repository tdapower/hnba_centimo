<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserSummaryDashboardNew.aspx.cs" Inherits="quickinfo_v2.Views.Dashboards.UserSummaryDashboardNew" %>
...
<body style="margin: 0; padding: 0; background: #fff; font-family: Arial, Verdana, Sans-Serif;">
    ...
    <div id="slider1_container" style="position: relative; width: 980px; height: 600px; overflow: hidden;">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1000px; height: 600px; overflow: hidden;">
            ...
            */
            ...
            <div u="navigator" class="jssorb03" style="bottom: 16px; right: 50px;">
